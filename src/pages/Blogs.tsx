      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl font-bold font-mono mb-4 text-coder-black dark:text-coder-white">
            <span className="text-coder-yellow">Developer</span> <span className="terminal-prompt">Blog</span>
          </h1>
            ...
            {filteredBlogs.map((blog: any) => (
              <article key={blog.id} className="card overflow-hidden cursor-pointer">
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-semibold font-mono mb-3 text-coder-black dark:text-coder-white text-coder-yellow">{blog.title}</h3>
