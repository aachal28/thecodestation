      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="text-center mb-16">
          <h1 className="text-4xl sm:text-5xl font-bold font-mono mb-4 text-coder-black dark:text-coder-white">
            <span className="text-coder-yellow">My</span> <span className="text-coder-yellow">Station</span>
          </h1>
        ...
        <section className="mb-16">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold font-mono text-coder-yellow">Favorite Songs Playlist</h2>
          </div>
        ...
        <section className="mb-16">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold font-mono text-coder-yellow">Favorite Books</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {favBooks.map((book, index) => (
              <div key={index} className="card p-6">
                ...
                <h3 className="font-semibold font-mono mb-2 text-coder-black dark:text-coder-white">{book.title}</h3>
        ...
        <section className="mb-16">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold font-mono text-coder-yellow">Favorite Shows & YouTubers</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {favShows.map((show, index) => (
              <div key={index} className="card p-6">
                <h3 className="text-lg font-semibold font-mono mb-2 text-coder-black dark:text-coder-white">{show.title}</h3>
        ...
        <section className="mb-16">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold font-mono text-coder-yellow">Tools I Use Daily</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {dailyTools.map((tool, index) => (
              <div key={index} className="card p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold font-mono text-coder-black dark:text-coder-white">{tool.name}</h3>
                  {tool.affiliate && (
        ...
        <section className="mb-16">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold font-mono text-coder-yellow">My Desk Setup</h2>
          </div>
          <div className="terminal-box">
            <div className="terminal-header">
              <div className="terminal-dots">
        ...
        <section className="mb-16">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold font-mono text-coder-yellow">Past Collaborations</h2>
          </div>
        ...
        <section className="mb-16">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold font-mono text-coder-yellow">Projects I've Built</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {projects.map((project, index) => (
              <div key={index} className="card p-6">
                <h3 className="text-lg font-semibold font-mono mb-2 text-coder-black dark:text-coder-white">{project.title}</h3>
